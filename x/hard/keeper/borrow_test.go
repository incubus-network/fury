	...
	testCases := []borrowTest{
		{
			"valid",
			args{
				musdBorrowLimit:           sdk.MustNewDecFromStr("100000000000"),
				...
				expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(1080*FURY_CF)), sdk.NewCoin("musd", sdkmath.NewInt(200*MUSD_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
			},
			errArgs{
				expectPass: true,
				contains:   "",
		...
		},
		{
			...
			args{
				...
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(61*MUSD_CF))), // 61 MUSD x $1 price = $61
		...
		},
		{
			...
			args{
				...
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(180*MUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(50*FURY_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(99.9*BTCB_CF)), sdk.NewCoin("musd", sdkmath.NewInt(180*MUSD_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(100*BNB_CF)), sdk.NewCoin("xyz", sdkmath.NewInt(1))),
				expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(1050*FURY_CF)), sdk.NewCoin("musd", sdkmath.NewInt(20*MUSD_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(0.1*BTCB_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
			},
			errArgs{
				expectPass: true,
				contains:   "",
		...
		},
		{
			...
			args{
				...
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(50*FURY_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(0.1*BTCB_CF))),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(181*MUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
			errArgs{
		...
		},
		{
			...
			args{
				...
				previousBorrowCoins:       sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(99*MUSD_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(1*MUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(50*FURY_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(100*BTCB_CF)), sdk.NewCoin("musd", sdkmath.NewInt(100*MUSD_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(70*BNB_CF)), sdk.NewCoin("xyz", sdkmath.NewInt(1))),
				expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(1050*FURY_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(30*BUSD_CF)), sdk.NewCoin("musd", sdkmath.NewInt(100*MUSD_CF))),
			},
			errArgs{
				expectPass: true,
				contains:   "",
		...
		},
		{
			...
			args{
				...
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              sdk.NewCoins(sdk.NewCoin("bnb", sdkmath.NewInt(30*BNB_CF)), sdk.NewCoin("ufury", sdkmath.NewInt(50*FURY_CF))), // (50 FURY x $2.00 price = $100) + (30 BNB x $5.00 price = $150) = $250
				previousBorrowCoins:       sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(100*MUSD_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(1*MUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
		...
		},
		{
			...
			args{
				musdBorrowLimit:           sdk.MustNewDecFromStr("20000000"),
				priceFURY:                 sdk.MustNewDecFromStr("2.00"),
				loanToValueFURY:           sdk.MustNewDecFromStr("0.8"),
				priceBTCB:                 sdk.MustNewDecFromStr("0.00"),
				loanToValueBTCB:           sdk.MustNewDecFromStr("0.01"),
				...
				previousBorrowCoins:       sdk.NewCoins(),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(25*MUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
			errArgs{
		...
		},
		{
			...
			args{
				...
				depositCoins:              sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(50*FURY_CF))),
				previousBorrowCoins:       sdk.NewCoins(),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(5*MUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
			errArgs{
		...
		},
		{
			...
			args{
				...
				depositCoins:              sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(50*FURY_CF))),
				previousBorrowCoins:       sdk.NewCoins(),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("musd", sdkmath.NewInt(5*MUSD_CF)), sdk.NewCoin("ufury", sdkmath.NewInt(2*MUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
			errArgs{
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			hardGS := types.NewGenesisState(types.NewParams(
				types.MoneyMarkets{
					types.NewMoneyMarket("musd", types.NewBorrowLimit(true, tc.args.musdBorrowLimit, sdk.MustNewDecFromStr("1")), "musd:usd", sdkmath.NewInt(MUSD_CF), types.NewInterestRateModel(sdk.MustNewDecFromStr("0.05"), sdk.MustNewDecFromStr("2"), sdk.MustNewDecFromStr("0.8"), sdk.MustNewDecFromStr("10")), sdk.MustNewDecFromStr("0.05"), sdk.ZeroDec()),
			...
			hardMaccCoins := sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(1000*FURY_CF)),
				sdk.NewCoin("musd", sdkmath.NewInt(200*MUSD_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF)))
...
func (suite *KeeperTestSuite) TestValidateBorrow() {
	...
	initialBorrowerBalance := sdk.NewCoins(
		...
		sdk.NewCoin("musd", sdkmath.NewInt(1000*FURY_CF)),
	)
		...
		types.NewParams(
			types.MoneyMarkets{
				types.NewMoneyMarket("musd",
					types.NewBorrowLimit(false, sdk.NewDec(100000000*MUSD_CF), sdk.MustNewDecFromStr("1")), // Borrow Limit
					"musd:usd",                     // Market ID
					sdkmath.NewInt(MUSD_CF),        // Conversion Factor
	...
	depositCoins := sdk.NewCoins(
		sdk.NewCoin("ufury", sdkmath.NewInt(100*FURY_CF)),
		sdk.NewCoin("musd", sdkmath.NewInt(100*MUSD_CF)),
	)
