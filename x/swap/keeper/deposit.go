...
//
// For example, if we have a pool with 100e6 ufury and 400e6 musd.  The ufury price is 4 musd and the
// musd price is 0.25 ufury.  If a depositor adds liquidity of 4e6 ufury and 14e6 musd, a fury price of
// 3.50 musd and a musd price of 0.29 ufury.  This is a -12.5% slippage is the ufury price, and a 14.3%
// slippage in the musd price.
//
