...
func (suite *keeperTestSuite) TestDeposit_CreatePool_PoolNotAllowed() {
	...
	amountB := sdk.NewCoin("musd", sdkmath.NewInt(50e6))

	err := suite.Keeper.Deposit(suite.Ctx, depositor.GetAddress(), amountA, amountB, sdk.MustNewDecFromStr("0.01"))
	suite.Require().EqualError(err, "can not create pool 'ufury:musd': not allowed")
}
...
func (suite *keeperTestSuite) TestDeposit_InsufficientFunds() {
	testCases := []struct {
	...
	}{
		{
			...
			depositB: sdk.NewCoin("musd", sdkmath.NewInt(100)),
		},
		{
			name:     "low balance",
			balanceA: sdk.NewCoin("ufury", sdkmath.NewInt(1000000)),
			balanceB: sdk.NewCoin("musd", sdkmath.NewInt(1000000)),
			depositA: sdk.NewCoin("ufury", sdkmath.NewInt(1000001)),
			depositB: sdk.NewCoin("musd", sdkmath.NewInt(10000001)),
		},
		{
			name:     "large balance difference",
			balanceA: sdk.NewCoin("ufury", sdkmath.NewInt(100e6)),
			balanceB: sdk.NewCoin("musd", sdkmath.NewInt(500e6)),
			depositA: sdk.NewCoin("ufury", sdkmath.NewInt(1000e6)),
			depositB: sdk.NewCoin("musd", sdkmath.NewInt(5000e6)),
		},
	}
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			err = suite.CreatePool(sdk.NewCoins(sdk.NewCoin("ufury", sdkmath.NewInt(10e6)), sdk.NewCoin("musd", sdkmath.NewInt(50e6))))
...
func (suite *keeperTestSuite) TestDeposit_InsufficientFunds_Vesting() {
	testCases := []struct {
	...
	}{
		{
			...
			balanceB: sdk.NewCoin("musd", sdk.ZeroInt()),
			vestingA: sdk.NewCoin("ufury", sdkmath.NewInt(100)),
			vestingB: sdk.NewCoin("musd", sdkmath.NewInt(100)),
			depositA: sdk.NewCoin("ufury", sdkmath.NewInt(100)),
			depositB: sdk.NewCoin("musd", sdkmath.NewInt(100)),
		},
		{
			...
			vestingB: sdk.NewCoin("musd", sdkmath.NewInt(1)),
			depositA: sdk.NewCoin("ufury", sdkmath.NewInt(1000001)),
			depositB: sdk.NewCoin("musd", sdkmath.NewInt(10000001)),
		},
		{
			...
			vestingB: sdk.NewCoin("musd", sdkmath.NewInt(5000e6)),
			depositA: sdk.NewCoin("ufury", sdkmath.NewInt(1000e6)),
			depositB: sdk.NewCoin("musd", sdkmath.NewInt(5000e6)),
		},
	}
...
func (suite *keeperTestSuite) TestDeposit_CreatePool() {
	pool := types.NewAllowedPool("ufury", "musd")
	suite.Require().NoError(pool.Validate())
	suite.Keeper.SetParams(suite.Ctx, types.NewParams(types.NewAllowedPools(pool), types.DefaultSwapFee))
...
func (suite *keeperTestSuite) TestDeposit_PoolExists() {
	...
	balance := sdk.NewCoins(
		...
		sdk.NewCoin("musd", sdkmath.NewInt(5e6)),
	)
	...
	depositA := sdk.NewCoin("musd", balance.AmountOf("musd"))
	...
	expectedShareValue := sdk.NewCoins(
		...
		sdk.NewCoin("musd", sdkmath.NewInt(4999998)),
	)
...
func (suite *keeperTestSuite) TestDeposit_MultipleDeposit() {
	fundsToDeposit := sdk.NewCoins(
		sdk.NewCoin("ufury", sdkmath.NewInt(5e6)),
		sdk.NewCoin("musd", sdkmath.NewInt(25e6)),
	)
	...
	depositA := sdk.NewCoin("musd", fundsToDeposit.AmountOf("musd"))
...
func (suite *keeperTestSuite) TestDeposit_Slippage() {
	...
	testCases := []struct {
		...
		{sdk.NewCoin("musd", sdkmath.NewInt(5e6)), sdk.NewCoin("ufury", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("0.7"), true},
		{sdk.NewCoin("musd", sdkmath.NewInt(5e6)), sdk.NewCoin("ufury", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("0.8"), true},
		{sdk.NewCoin("ufury", sdkmath.NewInt(5e6)), sdk.NewCoin("musd", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("3"), true},
		{sdk.NewCoin("ufury", sdkmath.NewInt(5e6)), sdk.NewCoin("musd", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("4"), false},
		{sdk.NewCoin("ufury", sdkmath.NewInt(1e6)), sdk.NewCoin("musd", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("0"), false},
		{sdk.NewCoin("ufury", sdkmath.NewInt(1e6)), sdk.NewCoin("musd", sdkmath.NewInt(4e6)), sdk.MustNewDecFromStr("0.25"), false},
		{sdk.NewCoin("ufury", sdkmath.NewInt(1e6)), sdk.NewCoin("musd", sdkmath.NewInt(4e6)), sdk.MustNewDecFromStr("0.2"), true},
	}
...
func (suite *keeperTestSuite) TestDeposit_InsufficientLiquidity() {
	testCases := []struct {
		...
		{sdk.NewCoin("ufury", sdkmath.NewInt(10e6)), sdk.NewCoin("musd", sdkmath.NewInt(50e6)), sdkmath.NewInt(40e6), sdk.NewCoin("ufury", sdkmath.NewInt(1)), sdk.NewCoin("musd", sdkmath.NewInt(1))},
		// test share value rounding to zero
		{sdk.NewCoin("ufury", sdkmath.NewInt(10e6)), sdk.NewCoin("musd", sdkmath.NewInt(10e6)), sdkmath.NewInt(100), sdk.NewCoin("ufury", sdkmath.NewInt(1000)), sdk.NewCoin("musd", sdkmath.NewInt(1000))},
	}
