...
// 	coins := []sdk.Coins{}
// 	for j := 0; j < 5; j++ {
// 		coins = append(coins, cs(c("ufury", 10000000000), c("bnb", 10000000000), c("musd", 10000000000)))
// 	}
...
// 	coinB := sdk.NewCoin("musd", sdkmath.NewInt(200))
...
// 	coinA := sdk.NewCoin("ufury", sdkmath.NewInt(10))
// 	coinB := sdk.NewCoin("musd", sdkmath.NewInt(200))
// 	coinC := sdk.NewCoin("musd", sdkmath.NewInt(200))
