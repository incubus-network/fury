...
func (suite *keeperTestSuite) TestWithdraw_PartialShares() {
	...
	minCoinA := sdk.NewCoin("musd", sdkmath.NewInt(25e6))
...
func (suite *keeperTestSuite) TestWithdraw_MinWithdraw() {
	...
	testCases := []struct {
		...
		{sdkmath.NewInt(1), sdk.NewCoin("ufury", sdkmath.NewInt(1)), sdk.NewCoin("musd", sdkmath.NewInt(1)), true},
		{sdkmath.NewInt(1), sdk.NewCoin("musd", sdkmath.NewInt(5)), sdk.NewCoin("ufury", sdkmath.NewInt(1)), true},

		{sdkmath.NewInt(2), sdk.NewCoin("ufury", sdkmath.NewInt(1)), sdk.NewCoin("musd", sdkmath.NewInt(1)), true},
		{sdkmath.NewInt(2), sdk.NewCoin("musd", sdkmath.NewInt(5)), sdk.NewCoin("ufury", sdkmath.NewInt(1)), true},

		{sdkmath.NewInt(3), sdk.NewCoin("ufury", sdkmath.NewInt(1)), sdk.NewCoin("musd", sdkmath.NewInt(5)), false},
		{sdkmath.NewInt(3), sdk.NewCoin("musd", sdkmath.NewInt(5)), sdk.NewCoin("ufury", sdkmath.NewInt(1)), false},
	}
...
func (suite *keeperTestSuite) TestWithdraw_BelowMinimum() {
	...
	testCases := []struct {
		...
		{sdkmath.NewInt(15e6), sdk.NewCoin("ufury", sdkmath.NewInt(5000001)), sdk.NewCoin("musd", sdkmath.NewInt(25e6)), true},
	}
...
func (suite *keeperTestSuite) TestWithdraw_PanicOnMissingPool() {
	...
	suite.PanicsWithValue("pool ufury:musd not found", func() {
