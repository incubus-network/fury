...
func cdps() (cdps types.CDPs) {
	...
	c1 := types.NewCDP(uint64(1), addrs[0], sdk.NewCoin("xrp", sdkmath.NewInt(100000000)), "xrp-a", sdk.NewCoin("musd", sdkmath.NewInt(8000000)), tmtime.Canonical(time.Now()), sdk.OneDec())
	...
	c4 := types.NewCDP(uint64(4), addrs[2], sdk.NewCoin("xrp", sdkmath.NewInt(1000000000)), "xrp-a", sdk.NewCoin("musd", sdkmath.NewInt(50000000)), tmtime.Canonical(time.Now()), sdk.OneDec())
