...
replace (
	...
	// Use rocksdb 7.9.2
	github.com/cometbft/cometbft-db => github.com/fury-labs/cometbft-db v0.7.0-rocksdb-v7.9.2-fury.1
	...
	github.com/tendermint/tm-db => github.com/fury-labs/tm-db v0.6.7-fury.3
)
